            ...
            <?php foreach ($related as $row): ?>
                <div class="c-6" style="margin-bottom: 30px;">
                    <div style="max-width: 100%">
                        ...
                        <a href="<?= base_url('link').'/'.$row['slug'] ?>" title="<?= $row['judul'] ?>" class="font-secondary" style="font-size: 16px; font-family: 'Lato', sans-serif;">
                        <h4 class="font-secondary m-0 p-0"><?= $row['judul'] ?></h4></a>
                    </div>
                </div>
            <?php endforeach ?>
        </div>
