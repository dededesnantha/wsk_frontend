            ...
            <div style="padding-bottom: 20px">
              <div style="float: left; margin: 0px 10px">
                ...
                <div style="float: none;">
                  <article>
                  <a href="<?= base_url('link/'.$row['slug']) ?>" title="<?= $row['judul'] ?>" style="text-decoration: none; color: #3498db;font-family: 'Lato', sans-serif;" >
                    <?= $row['judul'] ?></a>
                  </article>
                </div>
              </div>
    ...
    <li style="padding: 10px 0;">
      <aside>
        <div style="padding-bottom: 20px">
          ...
          <div style="float: none;">
            <article>
              <a href="<?= base_url('blog/'.$row['slug']) ?>" title="<?= $row['judul'] ?>" style="text-decoration: none; color: #3498db;font-family: 'Lato', sans-serif;" ><?= $row['judul'] ?></a></article>
            </div>
          </div>
        </aside>
      </li>
